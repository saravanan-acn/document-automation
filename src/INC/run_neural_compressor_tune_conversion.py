...
# pylint: disable=C0301, E0401, E0611, E1129, R0914
...
if __name__ == "__main__":
    ...
    test_input_ids, test_attention_mask = tokenize(
                                            X_test,
                                            tokenizer,
                                            max_len=MAX_LEN)
    ...
    VAL_ATTENTION_MASK = test_attention_mask
    X_TEST = X_test
    Y_TEST = y_test
    ...
    cmodel = common.Model(graph)
    # cmodel = common.Model(model_path)
